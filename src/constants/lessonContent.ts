...
export interface LessonSlide {
  icon: string;  // Ionicons name used as the slide hero illustration
  heading: string;
  body: string;
}
    ...
    slides: [
      {
        ...
        heading: 'Colours',
        body: 'Red, Blue, Yellow, Green, Orange, Purple, Black, White, Brown, Pink.\nColours describe how things look. What colour is your shirt?',
      },
      {
